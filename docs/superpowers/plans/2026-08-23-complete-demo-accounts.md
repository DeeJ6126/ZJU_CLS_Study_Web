...
- [ ] **Step 1: Add a failing browser-neutral normalization test**
...
- [ ] **Step 3: Extract pure normalization into `src/services/courseScheduleService.js`**
...
- [ ] **Step 4: Run `node --test tests/accountLearning.test.js` and expect all tests to pass**

### Task 2: Versioned Demo Repository And Seeds

- [ ] **Step 1: Write repository tests for seed realism and identity isolation**
...
- [ ] **Step 2: Run `node --test tests/demoAccountService.test.js` and confirm failure**

- [ ] **Step 3: Add realistic seeds and repository read/reset behavior**
...
- [ ] **Step 4: Add profile, course, favorite, post, submission, comment, and notification mutations**
...
- [ ] **Step 5: Add cross-identity moderation and audit records**
...
- [ ] **Step 6: Run `node --test tests/demoAccountService.test.js` and expect all tests to pass**

### Task 3: Browser File Workflows

- [ ] **Step 1: Add failing tests for avatar validation and workbook-row preview**
...
- [ ] **Step 2: Implement Data URL avatar persistence and browser XLSX parsing**
...
- [ ] **Step 3: Run repository and account-learning tests and expect all tests to pass**

### Task 4: Application Demo Routing

- [ ] **Step 1: Add App wiring assertions before implementation**
...
- [ ] **Step 2: Route identity switching and account dataset loading locally**
...
- [ ] **Step 3: Route profile and account mutations through demo methods**
...
- [ ] **Step 5: Run `node --test tests/demoIdentityService.test.js tests/profileUi.test.js tests/demoAccountService.test.js` and expect all tests to pass**

### Task 5: Demo Administrator Injection

- [ ] **Step 1: Add failing AdminPage contract assertions**

Check for `api-client` and `initial-user` props and ensure direct calls use the injected client.

- [ ] **Step 2: Make authentication and API dependencies injectable**
...
- [ ] **Step 3: Pass demo admin dependencies from `App.vue`**

Render the existing `AdminPage` with the selected demo administrator and local adapter. Real mode passes no overrides.

- [ ] **Step 4: Run `node --test tests/adminPlatform.test.js tests/demoAccountService.test.js` and expect all tests to pass**

### Task 6: UX, Documentation, And Verification

- [ ] **Step 1: Add visible local-demo notices and reset control**
