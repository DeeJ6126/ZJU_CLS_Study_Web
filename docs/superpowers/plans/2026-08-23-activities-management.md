...
- [x] **Step 2: Run `node --test tests/activityCatalog.test.js` and confirm failure**

- [x] **Step 3: Add the JSON catalog and extract selected DOCX images**
...
- [x] **Step 4: Run the catalog test and confirm it passes**
...
- [x] **Step 2: Run focused tests and confirm the missing APIs fail**

- [x] **Step 3: Add the activity table and validation service**
...
- [x] **Step 4: Add public and administrator endpoints**
...
- [x] **Step 5: Seed the catalog during server startup and run focused tests**
...
- [x] **Step 1: Write failing client and component contract tests**
...
- [x] **Step 2: Implement the public client**
...
- [x] **Step 3: Build the responsive activity page**
...
- [x] **Step 4: Wire the route through `App.vue` and run focused tests**
...
- [x] **Step 1: Write failing homepage assertions**
...
- [x] **Step 1: Add failing API and UI contract tests**
...
- [x] **Step 4: Run admin and demo tests**
...
- [x] **Step 3: Run `git diff --check` and focused tests**
